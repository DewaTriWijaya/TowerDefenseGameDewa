...
public class Tower : MonoBehaviour
{
    ...
    public void ChechkNearestEnemy(List<Enemy> enemies)
    {
    ...
    // Menembak musuh yng telah disimpan sebagai target
    public void ShootTarget()
    {
        ...
        {
            bool headHasAimed = Mathf.Abs(_towerHead.transform.rotation.eulerAngles.z - _targetRotaion.eulerAngles.z) < 10f;
            if (!headHasAimed)
            {
                return;
            }
    ...
    public void SeekTarget()
    {
        ...
        _targetRotaion = Quaternion.Euler(new Vector3(0f, 0f, targetAngle - 90f));

        _towerHead.transform.rotation = Quaternion.RotateTowards(_towerHead.transform.rotation, _targetRotaion, Time.deltaTime * 180f);
    }
