...
public class LevelManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // jika menekan tombol R, fungsi restart akan terpannggil
        ...
        // Counter untuk spawn enemy dlm jeda waktu yg ditentukan
        // Time.UnscaledDeltaTime adlh deltaTime yg independent, tidak terpengaruh oleh apapun kecuali game obj itu sndiri
        // jadi bisa digunakan sbgai penghitung waktu
        ...
        {
            tower.ChechkNearestEnemy(_spawnedEnemies);
            tower.SeekTarget();
            tower.ShootTarget();
        }
        ...
        foreach(Enemy enemy in _spawnedEnemies)
        {
            ...
            // Kenapa nialainya 0.1? krna untk lebih mentoleransi perbedaan posisi
    ...
    {
        // Mathf fungsinya untk mengambil angka terbesar 
    ...
    // untuk menampilkn garis penghubung dlm window scene
